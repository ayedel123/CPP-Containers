...
// //     Node<int> nodes[2];
// //     nodes[0] = Node<int>{&(rbtree2_val[0]), nullptr, nullptr, nullptr,
// black_node};
// //     nodes[1] = Node<int>{&(rbtree2_val[1]), nullptr, nullptr, &(nodes[0]),
// red_node};
...
// //     Node<int> nodes[4];
// //     nodes[0] = Node<int>{&(rbtree2_val[0]), nullptr, nullptr, &(nodes[1]),
// red_node};
// //     nodes[1] = Node<int>{&(rbtree2_val[1]), &(nodes[0]), nullptr,
// &(nodes[2]), black_node};
// //     nodes[2] = Node<int>{&(rbtree2_val[2]), nullptr, nullptr, &(nodes[3]),
// black_node};
// //     nodes[3] = Node<int>{&(rbtree2_val[3]), &(nodes[1]), &(nodes[2]),
// nullptr, black_node};
